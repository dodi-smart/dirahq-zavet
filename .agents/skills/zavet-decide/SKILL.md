...
metadata:
  source: "commands/decide.md"
  generated: "true"
---

<!-- GENERATED from commands/decide.md by scripts/gen-adapters.sh — do not edit. -->
...
Arguments: `[short description of the decision]` — available as $ARGUMENTS.
...
3. If this REPLACES an older decision, edit ONLY the old record's frontmatter:
   ...
   not exist.
4. Regenerate the index: `sh ".zavet/bin/zavet" index`
