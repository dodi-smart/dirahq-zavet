...
metadata:
  source: "commands/backfill.md"
  generated: "true"
---

<!-- GENERATED from commands/backfill.md by scripts/gen-adapters.sh — do not edit. -->
...
Arguments: `[optional area/feature to focus on, e.g. "auth" or "the sync pipeline"]` — available as $ARGUMENTS.
...
4. Regenerate the index (`sh ".zavet/bin/zavet" index`) and
